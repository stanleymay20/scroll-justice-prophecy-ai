...
export type ScrollJudgment = {
  id: string;
  petition_id: string;
  judged_by: 'ScrollAgent' | 'Prophet' | 'Court';
  verdict: 'Guilty' | 'Innocent' | 'Deferred';
  reason: string;
  action_required: 'Compensation' | 'Public Repentance' | 'Legal Filing' | 'ScrollCry Activation';
  timestamp: string;
};
...
export type UserRole = 'guest' | 'advocate' | 'seeker' | 'judge' | 'admin' | 'prophet';
